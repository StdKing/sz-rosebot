...
fbuttons = InlineKeyboardMarkup(
        [[InlineKeyboardButton(text="👥Support Group", url="https://t.me/DevilsheavliMF"),
          InlineKeyboardButton(text="👤News Channel", url="https://t.me/DevilsServerMF")], 
        [ InlineKeyboardButton(text="⚒ Source Code", url="https://github.com/StdKing/sz-rosebot"),
